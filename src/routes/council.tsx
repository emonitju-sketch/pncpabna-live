...
const executive: { role: string; name: string }[] = [
  ...
  { role: "প্রেসিডিয়াম সদস্য", name: "মো: শহীদুজ্জামান মতিন" },
  ...
  { role: "সহ-যুব বিষয়ক সম্পাদক", name: "মো: খলিলুর রহমান" },
  { role: "সাহিত্য ও সংস্কৃতি বিষয়ক সম্পাদক", name: "ইঞ্জি. মঞ্জুর হোসেন দীপ্ত" },
  ...
  { role: "মুক্তিযুদ্ধ বিষয়ক সম্পাদক", name: "মো: মোয়াল্লেমুল ইসলাম" },
  ...
  { role: "সদস্য", name: "মো: আবুল কালাম আজাদ" },
