...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://pncpabna.live/gallery" },
    ],
    links: [{ rel: "canonical", href: "https://pncpabna.live/gallery" }],
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        url: "https://pncpabna.live/gallery",
        inLanguage: "bn",
        isPartOf: { "@type": "WebSite", name: "PNC Pabna", url: "https://pncpabna.live/" },
      }),
    }],
  }),
