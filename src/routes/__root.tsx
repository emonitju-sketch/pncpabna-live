...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "পাবনা নাগরিক কমিটি (PNC) - নাগরিক ঐক্যেই বদলাবে পাবনা" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "পাবনা নাগরিক কমিটি (PNC) - নাগরিক ঐক্যেই বদলাবে পাবনা" },
      ...
      { name: "twitter:title", content: "পাবনা নাগরিক কমিটি (PNC) - নাগরিক ঐক্যেই বদলাবে পাবনা" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/YwWBgZ9dsAUZql5H6iDLXzh0xsz2/social-images/social-1779806406665-PNC_Banar.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/YwWBgZ9dsAUZql5H6iDLXzh0xsz2/social-images/social-1779806406665-PNC_Banar.webp" },
    ],
    scripts: [
      {
