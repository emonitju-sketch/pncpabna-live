...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "পাবনা নাগরিক কমিটি - পিএনসি (PNC) একটি নাগরিকভিত্তিক সামাজিক প্ল্যাটফর্ম, যা পাবনার উন্নয়ন, জনসচেতনতা, সামাজিক সম্প্রীতি এবং জনস্বার্থে কাজ করে। আমাদের বিশ্বাস নাগরিক ঐক্যেই বদলাবে পাবনা।" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "bn_BD" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "পাবনা নাগরিক কমিটি - পিএনসি | নাগরিক ঐক্যেই বদলাবে পাবনা" },
      { name: "twitter:description", content: "পাবনা নাগরিক কমিটি - পিএনসি (PNC) একটি নাগরিকভিত্তিক সামাজিক প্ল্যাটফর্ম, যা পাবনার উন্নয়ন, জনসচেতনতা, সামাজিক সম্প্রীতি এবং জনস্বার্থে কাজ করে। আমাদের বিশ্বাস নাগরিক ঐক্যেই বদলাবে পাবনা।" },
