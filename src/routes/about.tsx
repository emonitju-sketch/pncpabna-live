    ...
    <>
      ...
      <section className="container-pnc py-16 md:py-20 grid gap-10 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-5 text-muted-foreground leading-relaxed">
          ...
          <p>
            আমাদের কার্যক্রম দলীয় মতাদর্শের ঊর্ধ্বে — আমরা পাবনার সাধারণ মানুষের কণ্ঠস্বর তুলে ধরতে, যুব সমাজকে নেতৃত্বে আনতে এবং সমাজের প্রান্তিক মানুষের পাশে দাঁড়াতে কাজ করি।
          </p>
